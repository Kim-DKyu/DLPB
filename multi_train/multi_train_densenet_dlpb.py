...
from train.train_densenet_dlpb import run
...
def get_multi_args_parser():
    ...
    parser.add_argument('-m', '--model-name', type=str, nargs='+', default=['ga_densenetd40k12_branch_3'], help='list of model names')
    ...
    parser.add_argument('-p', '--project-name', type=str, default='dlpb-ga-densenet40k12', help='project name used for wandb logger')
