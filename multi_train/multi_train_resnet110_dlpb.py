...
from train.train_resnet110_dlpb import run
...
setting_dict = dict(
    cifar100_resnet110_dlpb='data --dataset_type CIFAR100 --train-size 32 32 --test-size 32 32 --train-resize-mode RandomCrop --random-crop-pad 4 --mean 0.5071 0.4865 0.4409 --std 0.2673 0.2564 0.2762 --epoch 300 --GA_lamb -0.5 --alpha 1 --optimizer sgd --nesterov --lr 0.1 --weight-decay 5e-4 --scheduler multistep --milestones 150 225 -b 128 -j 8',
)
...
def get_multi_args_parser():
    ...
    parser.add_argument('-m', '--model-name', type=str, nargs='+', default=['ga_resnet110_gram_dim_64_branch_3'], help='list of model names')
    ...
    parser.add_argument('-p', '--project-name', type=str, default='dlpb-ga-resnet110', help='project name used for wandb logger')
