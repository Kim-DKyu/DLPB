...
def get_args_parser():
    ...
    augmentation.add_argument('--cutmix', type=float, default=0.0, help='cutmix probability')
    augmentation.add_argument('--mixup', type=float, default=0.0, help='mix probability')
    augmentation.add_argument('-re', '--remode', type=float, default=0.0, help='random erasing probability')
    ...
    optimizer.add_argument('--GA_lamb', type=float, default=-0.8, help='optimizer eps')
    optimizer.add_argument('--dec-reduction', choices=['batchmean', 'mean'], default='batchmean',
                           help='reduction used only for the decorrelation KL loss')
    optimizer.add_argument('--alpha', type=float, default=1, help='optimizer eps')
    optimizer.add_argument('--number-net', type=int, default=4, help='optimizer eps')
    ...
    scheduler.add_argument('--warmup-epoch', type=int, default=0, help='warmup epoch')
    scheduler.add_argument('--temperature', type=int, default=1, help='warmup epoch')
    ...
    setup.add_argument('--wandb-run-id', type=str, default=None, help='existing W&B run ID used with --resume')
    setup.add_argument('-proj', '--project-name', type=str, default='pytorch-image-classification (cifar)', help='project name used for wandb logger')
    setup.add_argument('--who', type=str, default='dongu', help='enter your name')
    ...
    setup.add_argument('-s', '--seed', type=int, default=40, help='fix seed')
    ...
    setup.add_argument('--scn', type=str, default='dongu', help='enter your name')
